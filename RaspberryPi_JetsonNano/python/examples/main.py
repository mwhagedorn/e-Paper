...
logging.basicConfig(level=logging.INFO, filename='/home/mhagedorn/e-Paper/RaspberryPi_JetsonNano/python/examples/quotes.log')
...
def get_affirmations():
    ...
    affirmations = [
        "I am committed to doing my Miracle Morning every day so that I can become the person I need to be to create everything I want for my life.",
        "I don't judge or condemn others, because I simply have no way of knowing that if I had lived their life, I might be, say and do exactly the same",
        "I don't worry about trying to impresss people.  Instead, I focus on how I can add value to their lives.",
        "There is no better day than today to do the things I've been putting off.",
        "To reach levels of success I've never reached before, I must be committed at a level I've never been committed at before.",
        "To avoid the activities I know I should be doing is to avoid the life I want to be living.  I will stop avoiding and start living.",
        "It's often said that everything happens for a reason, however it is my responsibility to choose the most empowering reasons for each of the experiences in my life.",
        "Happiness is a choice.  I choose to be happy.",
        "Today I am willing to give up who I've been for who I can become.",
        "I am committed to taking myself to the next level so that I can take my success to the next level, because it only happens in that order",
        "I was born with an innate inner freedom, which is my inherent ability to decide how I experience each moment in my life",
        ...
        "Where I am in my life is a result of who I was in the past, but where I go depends entirely on who I choose to be, from this moment on.",
        ...
        "There is nothing to fear because I cannot fail.  I can only learn, grow and become better than I've ever been before",
